...
/**
 * This annotation is used for parameters of an override or VM builtin implementation (not an interface method).
 * An annotated parameter is declared to point to a spell ring (referring to a module
 * containing the method implementation) and is technically something like a <code>this</code> pointer. <br />
